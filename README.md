# NodeMCU v2 + RFID-RC522
NodeMCU v2 podłączamy do RFID-RC522 za pomocą odpowiednich pinów.
```
RST     = GPIO5   -> D1
SDA(SS) = GPIO4   -> D2
MOSI    = GPIO13  -> D7
...
Po zbliżeniu karty o odpowiednim ID uruchamia się URL (GET) np. REST który dalej uruchamia coś na serwerze lub zapisuje dane fantazja dowolna.

Wszystko zapisujemy za pomocą aplikacji Arduino IDE z odpowiednią konfiguracją dla ESP8266. Instalujemy odpowiednie biblioteki w Arduino IDE.
